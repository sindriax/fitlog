...
export const machineTranslations: Record<string, { en: string; es: string }> = {
	...
	'Reverse Grip Lat Pulldown': { en: 'Reverse Grip Lat Pulldown', es: 'Jalón al Pecho Agarre Invertido' },
	'Neutral Grip Lat Pulldown': { en: 'Neutral Grip Lat Pulldown', es: 'Jalón al Pecho Agarre Neutro' },
	'Single Arm Lat Pulldown': { en: 'Single Arm Lat Pulldown', es: 'Jalón al Pecho Un Brazo' },
